...
public class ResumeMysqlDao {
    ...
    public static ResumeMysqlDao getResumeDao() {
    ...
    public int[] insertResumeEmail(ArrayList<String> emailList, int rid) throws SQLException {
   	PreparedStatement preparedStatementInsert = null;
   	String insertResume = "INSERT INTO  `resume_email`"
   		+ "(`rid` ,`email`) VALUES" + "(?,?)";
   	ResultSet generatedKeys = null;
   	try {
   	    preparedStatementInsert = mysqlDbConnection.prepareStatement(
   		...
   		preparedStatementInsert.setInt(1, rid);
   	   	preparedStatementInsert.setString(2, emailList.get(counter));
   	   	preparedStatementInsert.addBatch();
   	   	preparedStatementInsert.clearParameters();
   	    }
   	    int[] results = preparedStatementInsert.executeBatch();
